...
import StartNow from '../public/Stream Now.png'
...
const Hero = () => {
  ...
  return (
    ...
    <div className='flex flex-col gap-y-16 justify-center items-center'>
      ...
      <button className="bg-[#00FF00] text-black rounded-lg w-48 h-8 px-4 flex items-center justify-center hover:bg-white" onClick={() => {
