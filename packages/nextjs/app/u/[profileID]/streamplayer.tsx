...
export const PlayerLoading = ({ title, description }: { title?: React.ReactNode; description?: React.ReactNode }) => (
    ...
    return (
      <Popover.Root>
        <Popover.Trigger ref={ref} asChild>
          <button type="button" className={className} aria-label="Playback settings" onClick={e => e.stopPropagation()}>
            <SettingsIcon />
          </button>
        </Popover.Trigger>
        <Popover.Portal>
